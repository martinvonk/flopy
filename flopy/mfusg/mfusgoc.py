...
class MfUsgOc(Package):
    ...
    iddnfm : int
        ...
        (default is 0).
    ispcfm : int
        is a code for the format in which concentration will be printed.
        (default is 0).
    chedfm : string
    ...
    cddnfm : string
        ...
        (default is None)
    cspcfm : string
        is a character value that specifies the format for saving concentration.
    cboufm : string
    ...
    def load(
        ...
        if ispcun > 0:
            ...
            try:
                ...
                if model.verbose:
                    print("conc file name will be generated by flopy")
        if ibouun > 0:
            unitnumber[4] = ibouun
            try:
